 ...
 *
 * An animal dragged through a channel should still be dripping when it arrives, not dry
 * the instant it leaves the zone -- the drip is most of what tells the player the water
 * did something to it.
 */
function soak(r, dt) {
  for (const s of r.strand) {
